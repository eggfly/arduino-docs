...
void  LED_on(void)
{
    gpio_set(LED_PORT,LED0,LED_ON);
    gpio_set(LED_PORT,LED1,LED_ON);
    gpio_set(LED_PORT,LED2,LED_ON);
    gpio_set(LED_PORT,LED3,LED_ON);
}

void    LED_off(void)
{
    gpio_set(LED_PORT,LED0,LED_OFF);
    gpio_set(LED_PORT,LED1,LED_OFF);
    gpio_set(LED_PORT,LED2,LED_OFF);
    gpio_set(LED_PORT,LED3,LED_OFF);
}
